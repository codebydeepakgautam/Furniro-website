  ...
  return (
    <section className="py-12 px-4 bg-white text-center max-w-7xl mx-auto">
     ...
     <div className="flex justify-center mt-10">
         <button className="px-6 py-2   text-yellow-700 font-semibold rounded hover:bg-yellow-50 transition">
         <div className="flex space-x-4">
         <button className="bg-yellow-700 text-white px-4 py-2 rounded">1</button>
         <button className="bg-white text-black px-4 py-2 rounded">2</button>
         <button className="bg-white text-black px-4 py-2 rounded">3</button>
         <button className="bg-white text-black px-4 py-2 rounded">Next</button>
       </div>
