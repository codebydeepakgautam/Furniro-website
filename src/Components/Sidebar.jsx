...
import laptopo from '../assets/Image/Rectangle 68 (1).png'
...
const Blog = () => {
  ...
  <button className="border-b-2 my-5 border-black pb-1 hover:text-gray-600">
    Read more
        ...
        <div className="mt-6">
          <img src={laptopo} alt="Laptop on desk" className="rounded-lg w-full" />
        </div>
          ...
          <div className="space-y-8">
            {recentPosts.map((post, idx) => (
              <div key={idx} className="flex items-start gap-3">
                <img src={post.img} alt={post.title} className="w-16 h-16 rounded object-cover" />
                <div>
